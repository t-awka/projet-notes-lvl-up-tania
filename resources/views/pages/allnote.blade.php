                ...
                <div class="w-full max-w-sm px-4 py-3 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <div>
                        <div class="flex items-center mt-2 text-gray-700 dark:text-gray-200">
                            <span>Ecrit par:</span>
                            <p class="mx-2 text-blue-600 cursor-pointer dark:text-blue-400 hover:underline">
                        ...
                        <div class="flex items-center justify-center mt-4">
                            ...
                            <a href="/note/{{ $note->id }}"
                                class="px-5 font-semibold text-gray-100 transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700">Lire</a>
                        </div>
                    </div>
                </div>
            </div>
